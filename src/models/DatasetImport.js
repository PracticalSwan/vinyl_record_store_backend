...
export const datasetImportSchema = new mongoose.Schema(
  {
    ...
    productCollection: {
      ...
      required: true,
      immutable: true,
      enum: ["vinylRecords", "datasetProducts"],
      default: "vinylRecords",
    },
    status: {
      type: String,
      required: true,
    ...
    identityRegistryDigest: { type: String, default: null, match: /^[0-9a-f]{64}$/ },
    artworkEntriesDigest: { type: String, default: null, match: /^[0-9a-f]{64}$/ },
