...
Catalog adapters must preserve literal search, repeated-facet semantics, deterministic sorting and pagination, full active-catalog facets, soft-delete exclusion, and safe persistence errors. Customer repositories must preserve session-owned access, transaction safety, event/merge idempotency, and safe service errors.
