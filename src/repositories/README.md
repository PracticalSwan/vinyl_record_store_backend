...
- `historicalEvaluationRepository.js` reads only the exact pinned dataset/product/rating projections requested by the offline stage, streams rating rows through the historical adapter, and rechecks the active immutable descriptor before publishing aggregate artifacts.
