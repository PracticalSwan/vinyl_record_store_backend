...
- `FUTURE_IMPLEMENTATION_PLAN.md`: completed BFP-01/BFP-03/BFP-04 records plus approved future evaluation-data, ingestion, and admin plans; recommender selection is on hold.
