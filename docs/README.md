...
These files document the implemented read-only API, optional MongoDB catalog persistence, and explainable demo recommender.
...
- `DATA_MODEL_PLAN.md`: seed shape, implemented Mongoose models, indexes, and current write boundary.
...
- `FUTURE_IMPLEMENTATION_PLAN.md`: completed BFP-01 record plus approved future auth, writes, evaluation-data, ingestion, and admin plans; recommender selection is on hold.
