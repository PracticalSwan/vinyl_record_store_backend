...
- `RECOMMENDER_SYSTEM_PLAN.md`: implemented content/demo and optional preference-profile scoring, explanations, diversity, restricted showcase, session-owned fallback, and exact feedback rules.
...
- `FUTURE_IMPLEMENTATION_PLAN.md`: completed BFP-01/02/03/04/06/07/08/09 and PERS-00 through PERS-05 records plus remaining deferred work; recommender selection stays as a historical on-hold placeholder.
- `PERSONALIZATION_IMPLEMENTATION_PLAN.md`: PERS-00 through PERS-05 completed 2026-08-10 behind default-off flags; PERS-06 through PERS-09 remain planned, with no quality claim.
