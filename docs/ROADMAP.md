...
- Behavioral, popularity, and hybrid personalization (PERS-06 through PERS-09 / BFP-13 through BFP-16). PERS-03 through PERS-05 are implemented behind default-off flags; BFP-05 remains on hold as a historical placeholder whose open method decision was resolved by PERS-00. No quality claim is made; collaborative filtering and matrix factorization are excluded.
