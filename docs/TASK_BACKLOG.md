...
| B-028 | Decide whether one offline collaborative experiment is justified. | deferred | NEXT-02 is active and must use only sealed validation plus train-only aggregate support/overlap evidence. No live integration is authorized. |
